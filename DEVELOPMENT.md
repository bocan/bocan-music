...
| `make data-dictionary` | Regenerate `docs/data-dictionary.md` (every table and column with grep-derived writers / readers) from a copy of the real library, merging the curated `docs/data-dictionary-notes.json`. Edit the notes file, never the generated tables |

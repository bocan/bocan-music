...
public extension AudioEngine {
    ...
    internal func fadePlayerNode(to target: Float, durationMs: Int = 10, steps: Int = 5) async {
    ...
    func startObservingOutputDeviceChanges() async {
    ...
    func stopObservingOutputDeviceChanges() async {

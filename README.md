...
- **Real-time visualisers**: spectrum bars, oscilloscope, and a Metal GPU fluid shader, dockable or full-screen with `⌘⇧F`. Six colour palettes, including a music-steered Drift and a magnitude-to-heat Thermal ramp.

...
|---|---|---|---|---|---|
| `album_id` (pk) | INTEGER | A11yIdentifiers.swift, AlbumDetailView.swift, AlbumRepository.swift, AlbumsGridView.swift, AlbumsViewModel.swift (+38) | AlbumRepository+CollectionCards.swift, Artwork.swift, CrossfadeScheduler.swift, FieldDefinitions.swift, HistoryTableCoordinator.swift (+17) | M001 |  |
...
| `album_artist_id` | INTEGER | AlbumRepository.swift, AlbumsViewModel.swift, ArtistRepository.swift, EditTransaction.swift, LibraryStatsRepository+Hygiene.swift (+5) | AlbumDetailView.swift, AlbumRepository+CollectionCards.swift, AlbumsGridView.swift, BatchCoverArtViewModel.swift, DeepDiveService.swift (+10) | M001 |  |
| `album_id` | INTEGER | A11yIdentifiers.swift, AlbumDetailView.swift, AlbumRepository.swift, AlbumsGridView.swift, AlbumsViewModel.swift (+38) | AlbumRepository+CollectionCards.swift, Artwork.swift, CrossfadeScheduler.swift, FieldDefinitions.swift, HistoryTableCoordinator.swift (+17) | M001 |  |
...
| `replaygain_track_gain` | REAL | BackupRing.swift, LibraryViewModel.swift, TagDiff.swift, TagWriter.swift, TrackImporter.swift (+1) | EditTransaction.swift, ManifestBuilder.swift, QueueReplayGain.swift, SyncMetaRepository.swift, TagEditorSheet+InfoTabs.swift (+1) | ADR-013, #423 | From tags when present, else the app-computed value, which TrackImporter now keeps on rescan (#423). A full rescan on 2026-08-28 wiped 13,000 computed values before the fix. |
| `replaygain_track_peak` | REAL | BackupRing.swift, LibraryViewModel.swift, TagDiff.swift, TagWriter.swift, TrackImporter.swift (+1) | LibraryStatsRepository+AudioQuality.swift, ManifestBuilder.swift, QueueReplayGain.swift, SyncMetaRepository.swift, TagEditorSheet+InfoTabs.swift (+1) | M001 |  |
| `replaygain_album_gain` | REAL | BackupRing.swift, TagDiff.swift, TagWriter.swift, TrackImporter.swift, TrackTagPatch.swift | ManifestBuilder.swift, QueueReplayGain.swift, SyncMetaRepository.swift, TagEditorSheet+InfoTabs.swift, TagReader.swift | M001 |  |
| `replaygain_album_peak` | REAL | BackupRing.swift, TagDiff.swift, TagWriter.swift, TrackImporter.swift, TrackTagPatch.swift | ManifestBuilder.swift, QueueReplayGain.swift, SyncMetaRepository.swift, TagEditorSheet+InfoTabs.swift, TagReader.swift | M001 |  |

...
Rows reviewed: 53. Rows with only a migration reference: 240.
...
|---|---|---|---|---|---|
| `album_id` (pk) | INTEGER | A11yIdentifiers.swift, AlbumDetailView.swift, AlbumRepository.swift, AlbumsGridView.swift, AlbumsViewModel.swift (+38) | AlbumRepository+CollectionCards.swift, Artwork.swift, FieldDefinitions.swift, HistoryTableCoordinator.swift, HistoryView.swift (+15) | M001 |  |
...
| `cover_art_hash` | TEXT | AlbumRepository.swift, EditTransaction.swift, MetadataEditService.swift, TrackImporter.swift | AlbumDetailView.swift, Artwork.swift, BackupRing.swift, BatchCoverArtViewModel.swift, FieldDefinitions.swift (+5) | M001 |  |
...
| column | type | written by | read by | traces to | notes |
|---|---|---|---|---|---|
| `podcast_id` (pk) | INTEGER | AutoDownloadCoordinator.swift, ContentPane.swift, ContinueListeningRail.swift, DownloadStore.swift, EpisodeDownload.swift (+25) | LibraryStatsRepository+PodcastBehaviour.swift, PodcastTransportControls.swift | M023 |  |
...
|---|---|---|---|---|---|
| `id` (pk) | INTEGER | n/a (common identifier, see notes) | n/a | M001 |  |
| `podcast_id` | INTEGER | AutoDownloadCoordinator.swift, ContentPane.swift, ContinueListeningRail.swift, DownloadStore.swift, EpisodeDownload.swift (+25) | LibraryStatsRepository+PodcastBehaviour.swift, PodcastTransportControls.swift | M023 |  |
...
| `duration` | REAL | n/a (common identifier, see notes) | n/a | M001 |  |
| `sample_rate` | INTEGER | AVFoundationProperties.swift, AudioEngine+GaplessAPI.swift, AudioEngine.swift, AudioTap.swift, AudioTime.swift (+24) | A11yIdentifiers.swift, AVFoundationDecoder.swift, AppLogger.swift, AudioTranscoder+Pipeline.swift, BufferPump.swift (+15) | M001 |  |
...
| `channel_count` | INTEGER | FFmpegDecoder+StreamDetails.swift, LibraryViewModel+Radio.swift, LibraryViewModel+Subsonic.swift, Manifest.swift, ManifestBuilder.swift (+6) | AVFoundationProperties.swift, AudioTap.swift, BufferPump.swift, DecoderFactory.swift, FFmpegDecoder.swift (+10) | ADR-091, #513 | Channel count from the tag reader: TagLib, or AVFoundation for a raw Dolby file TagLib cannot parse. Read by TrackInfoPanel.swift and TagEditorSheet+InfoTabs.swift, which show it as a layout name (Mono, Stereo, 5.1, 7.1, else a count) with hover text saying a surround mix plays folded to stereo. Playback folds every source channel into stereo, so the value describes the file, not what is heard. |
...
| `album_artist_id` | INTEGER | AlbumRepository.swift, AlbumsViewModel.swift, ArtistRepository.swift, EditTransaction.swift, LibraryStatsRepository+Hygiene.swift (+5) | AlbumDetailView.swift, AlbumRepository+CollectionCards.swift, AlbumsGridView.swift, BatchCoverArtViewModel.swift, DeepDiveService.swift (+10) | M001 |  |
| `album_id` | INTEGER | A11yIdentifiers.swift, AlbumDetailView.swift, AlbumRepository.swift, AlbumsGridView.swift, AlbumsViewModel.swift (+38) | AlbumRepository+CollectionCards.swift, Artwork.swift, FieldDefinitions.swift, HistoryTableCoordinator.swift, HistoryView.swift (+15) | M001 |  |
...
| `replaygain_track_gain` | REAL | BackupRing.swift, LibraryViewModel.swift, TagDiff.swift, TagWriter.swift, TrackImporter.swift (+1) | EditTransaction.swift, ManifestBuilder.swift, SyncMetaRepository.swift, TagEditorSheet+InfoTabs.swift, TagReader.swift | ADR-013, #423 | From tags when present, else the app-computed value, which TrackImporter now keeps on rescan (#423). A full rescan on 2026-08-28 wiped 13,000 computed values before the fix. |
| `replaygain_track_peak` | REAL | BackupRing.swift, LibraryViewModel.swift, TagDiff.swift, TagWriter.swift, TrackImporter.swift (+1) | LibraryStatsRepository+AudioQuality.swift, ManifestBuilder.swift, SyncMetaRepository.swift, TagEditorSheet+InfoTabs.swift, TagReader.swift | M001 |  |
| `replaygain_album_gain` | REAL | BackupRing.swift, TagDiff.swift, TagWriter.swift, TrackImporter.swift, TrackTagPatch.swift | ManifestBuilder.swift, SyncMetaRepository.swift, TagEditorSheet+InfoTabs.swift, TagReader.swift | M001 |  |
| `replaygain_album_peak` | REAL | BackupRing.swift, TagDiff.swift, TagWriter.swift, TrackImporter.swift, TrackTagPatch.swift | ManifestBuilder.swift, SyncMetaRepository.swift, TagEditorSheet+InfoTabs.swift, TagReader.swift | M001 |  |

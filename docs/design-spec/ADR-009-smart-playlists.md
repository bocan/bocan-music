# ADR-009 — Smart Playlists

> Prerequisites: ADR-001–6 complete. Manual playlists work.
>
...
- Sync/export of smart criteria to other apps — ADR-030 handles M3U only.
...
ADR-010 (Metadata Editor) expects:

# ADR-031 — AirPlay routing

> Prerequisites: ADR-001–14 complete. AudioEngine survives system output device changes.
>
...
11. The audio engine itself does **not** need new code — `AVAudioEngine`
    ...
    notifications from earlier ADRs.
...
ADR-032 (Distribution) inherits no extra entitlements from this ADR.

...
**After all other ADR-037 slices are complete**, a dedicated spec file should be written to scope out the FeedKit upgrade path. That spec should cover:
...
A suggested filename for that future spec: `ADR-048-feedkit-upgrade.md`.

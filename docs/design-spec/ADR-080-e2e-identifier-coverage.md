# ADR-080: E2E Identifier and Help-Text Coverage

> Prerequisites: ADR-079 (fixture mode, harness, `make test-e2e`).
...
> namespace covers many surfaces but not all; this ADR makes coverage
...
- Clicking the controls (ADR-081 to ADR-083). This ADR only makes them
...
ADR-081 to ADR-083 may assume any control they want to click is reachable as

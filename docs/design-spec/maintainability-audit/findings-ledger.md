...
- Consolidated: _3_  ·  Tolerated: _32_  ·  Rejected: _6_  ·  Deferred: _8_
...
- Session 7 queue (deferred to next UI session): #349 scroll-offset restore modifier (S6-5, dedup 3 grids); confirm `CollectionModeToggle`/`ErrorState` aren't shadowed by inline Browse copies (S6-6).

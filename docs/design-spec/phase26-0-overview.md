# Phase 26: Podcast Analytics

> Prerequisites: Phases 0-25 complete. The Library Summary window (#373) has
...
### 26-1: The accounting (Persistence + UI)
...
### 26-2: The behaviour (Persistence + UI)
...
- No schema changes: `first_played_at` stays unrecorded until a phase needs
